...
export const SESSION_REFRESH_MAX_AGE_MS = 1000 * 60 * 60 * 24 * 30;
export const SESSION_REFRESH_MAX_AGE_SECONDS = SESSION_REFRESH_MAX_AGE_MS / 1000;
export const SESSION_REFRESH_IMMINENT_MS = 1000 * 60 * 60 * 24 * 3;
export const SESSION_REFRESH_IMMINENT_SECONDS = SESSION_REFRESH_IMMINENT_MS / 1000;
